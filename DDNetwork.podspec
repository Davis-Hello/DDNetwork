...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Davis-Hello/DDNetwork'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Davis-Hello' => 'json_feng@outlook.com' }
  s.source           = { :git => 'https://github.com/Davis-Hello/DDNetwork.git', :tag => s.version.to_s }
